      ...
      <section className='cardbox' style={{paddingTop:'10vh'}}>
        <div className="card p-[8]" onClick={() => handleClick(sum6)} style={{ boxShadow: 'none' }}>
          <div className="imgbox">
            <img className='boximg' src={sum7} alt="Eye Glasses" style={{ boxShadow: 'none', border: 'none', width: '50%', height: 'auto' }} />
          </div>
        ...
        <div className="card" onClick={() => handleClick(sum)}>
          <div className="imgbox ">
            <img className='boximg' src={sum} alt="Sun Glasses" style={{ boxShadow: 'none', border: 'none', width: '50%', height: 'auto' }} />
          </div>
          <div className="content">
        ...
        <div className="card" onClick={() => handleClick(sum2)}>
          <div className="imgbox">
            <img className='boximg' src={sum2} alt="Computer Glasses" style={{ boxShadow: 'none', border: 'none', width: '50%', height: 'auto' }} />
          </div>
          <div className="content">
        ...
        <div className="card" onClick={() => handleClick(sum3)}>
          <div className="imgbox">
            <img className='boximg' src={sum3} alt="Power Sunglasses" style={{ boxShadow: 'none', border: 'none', width: '50%', height: 'auto' }} />
          </div>
          <div className="content">
        ...
        <div className="card" onClick={() => handleClick(sum4)}>
          <div className="imgbox">
            <img className='boximg' src={sum4} alt="Progressive Lenses" style={{ boxShadow: 'none', border: 'none', width: '50%', height: 'auto' }} />
          </div>
          <div className="content">
